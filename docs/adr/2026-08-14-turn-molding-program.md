...
**Status:** Accepted; Track 1 complete (`v5.1.0-gs.1`); Track 2 in progress (Slice 1 complete, PR #25; Slice 2 on the frontier); Track 3 gated, plan pending
...
| 2 | Modernize the kept API (M1) | [plan](2026-08-15-modernize-kept-api-plan.md) | the-sarge/turn#19 | Track 1 (complete); wiremux Slice 1.3 (complete, GridSwarm/wiremux#1162) | 5 | FRONTIER — Slice 1 complete (PR #25); Slice 2 dispatchable; 3 and 4 parallel-safe after 2; 5 after 3 and 4 |
