...
**Status:** Accepted; Track 1 complete (`v5.1.0-gs.1`); Track 2 accepted 2026-08-15 with Slice 1 on the frontier; Track 3 gated, plan pending
...
| 2 | Modernize the kept API (M1) | [plan](2026-08-15-modernize-kept-api-plan.md) | pending | Track 1 (complete); wiremux Slice 1.3 (complete, GridSwarm/wiremux#1162) | 5 | FRONTIER — Slice 1 dispatchable; 2 after 1; 3 and 4 parallel-safe after 2; 5 after 3 and 4 |
