...
**Status:** Complete via PRs #96, #98, #100, #103, #105, and #108
...
| 4 | Allocate exchange | [plan](2026-08-19-allocate-exchange-plan.md) | [#88](https://github.com/the-sarge/turn/issues/88) | None | 1 | Complete via PR #108 |

All six audited slices are complete, so this program has no remaining implementation frontier. The completed work preserved the declared blocking graph and ownership boundaries; #83 remains the separate behaviour decision for `REQUESTED-ADDRESS-FAMILY` placement.
